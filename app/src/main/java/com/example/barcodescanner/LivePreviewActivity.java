...
import com.example.barcodescanner.common.CameraSourcePreview;
import com.example.barcodescanner.common.GraphicOverlay;
import com.example.barcodescanner.common.OverlayView;
...
public final class LivePreviewActivity extends AppCompatActivity
    implements OnRequestPermissionsResultCallback,
        CompoundButton.OnCheckedChangeListener, BarcodeScanningProcessor.BarcodeListener {
  private static final String BARCODE_DETECTION = "Barcode Detection";
  public static final String BARCODE = "BARCODE";
  private static final String TAG = "LivePreviewActivity";
  private static final int PERMISSION_REQUESTS = 1;

  public static int SUCCESS_BARCODE_DETECTON=1;
  public static int FAILED_BARCODE_DETECTON=0;
  ...
  public void onSuccess(FirebaseVisionBarcode barcode) {
    ...
    setResult(SUCCESS_BARCODE_DETECTON,intent);
    finish();
  }

  @Override
  public void onFailure() {
    setResult(FAILED_BARCODE_DETECTON);
    finish();
  }
}
